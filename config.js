...
(async function () {
  ...
  function loadCharityFix(){const p=location.pathname;if(!p.endsWith('charity.html')&&!p.endsWith('charity-submission-receipt.html'))return;if(document.getElementById('charity-security-fix'))return;const s=document.createElement('script');s.id='charity-security-fix';s.src='charity-security-fix.js?v=20260816-2';s.defer=true;document.head.appendChild(s);}
  const start=()=>{publicRefresh();applyAdminBrand();loadFinalCms();syncEditorFields();loadCharityFix();};
